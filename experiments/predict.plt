...
set lmargin 12
set bmargin 4
set ylabel 'Energy consumption, TWh' font 'Helvetica, 34'
...
#set yrange [0:110]
#set xrange [0:24]
plot 'energy_prediction.txt' every 1 using 1:2 with linespoints pt 1  ps 2 title "Non-IT infrastructure"\
,'energy_prediction.txt' every 1 using 1:(3) with linespoints pt 2 ps 2 title "Network"\
,'energy_prediction.txt' every 1 using 1:4 with linespoints pt 3 ps 2 title "Storage"\
,'energy_prediction.txt' every 1 using 1:5 with linespoints pt 4 ps 2 title "Servers"
