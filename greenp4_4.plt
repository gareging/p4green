...
#set yrange [0:110]
set xrange [0:24]
plot 'log4.txt' every 1 using ($1/13):($2/1000) with linespoints pi 5 pt 6  ps 2 title "Host 1"\
,'log4.txt' every 1 using ($1/13):($3/1000) with linespoints pi 5 pt 4 ps 2 title "Host 2"
